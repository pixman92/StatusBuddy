...
async function pullFromSavedEmails(myEmail){
    ...
    async function four(three3){
        ...
        for(var i=0; i<arrOfClickableEmails.length; i++){
            document.getElementById(arrOfClickableEmails[i]).addEventListener('click', async()=>{
                pullStatus(arrOfClickableEmails[i]);
            });
        }
